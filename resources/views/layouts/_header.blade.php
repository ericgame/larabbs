    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item {{ category_nav_active(2) }}"><a class="nav-link" href="{{ route('categories.show', 2) }}">課程</a></li>
            ...
            <ul class="navbar-nav navbar-right">
                ...
                @guest
                    <li calss="nav-item"><a class="nav-link" href="{{ route('login') }}">登入</a></li>
                    <li calss="nav-item"><a class="nav-link" href="{{ route('register') }}">註冊</a></li>
                @else
                    <li class="nav-item">
